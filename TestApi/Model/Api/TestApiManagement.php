<?php
namespace Mageget\TestApi\Model\Api;
class TestApiManagement implements \Mageget\TestApi\Api\TestApiManagementInterface
{
    ...
    public function __construct(
        \Mageget\TestApi\Model\TestApiFactory $testApiFactory
    ) {
